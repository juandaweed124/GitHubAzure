...
export class PdfService {
  ...
  async PdfExternoCuantitativo(arrInformacionPDF: any[], infoCabero: any, resumenMuestras: any[], cabecerosResumen: any[],resumenRonda: any[],imagenesRonda:any[] ,clienteInfo:any) {
    ...
    pdf.add(
      new Stack([
        new Txt([
          ...
          `, new Txt(`ID:`).bold().end, ` Índice de desvío.
    ...
    pdf.add(
      new Stack([
        new Txt('----------------Datos totales--------------').width('*').alignment('center').bold().margin([0, 25, 0, 0]).color('#8C8989').fontSize(13).end,
        new Txt('Z-score < -2 o > 2 = ' + idMenor).width('*').alignment('center').bold().margin([0, 10, 0, 0]).color('#B3B1B1').fontSize(11).end,
        new Txt('Z-score > -2 o < 2 = ' + idMayor).width('*').alignment('center').bold().margin([0, 10, 0, 0]).color('#B3B1B1').fontSize(11).end,
        new Txt('Total = ' + resumenMuestras.length).width('*').alignment('center').bold().margin([0, 10, 0, 0]).color('#B3B1B1').fontSize(11).end
      ]).end
    )    
